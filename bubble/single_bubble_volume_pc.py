...
class SingleBubbleLaserProblem(Problem):
    def __init__(self):
        ...
        self.contact_angle=self.theta0 # equilibrium contact angle 
        # Sticking coefficient as parameter. Starts at 0        
    ...
    def get_interface_properties(self):
        if self.interface is None:
            ...
            #mass_transfer_model.sticking_coefficient=0.0
    ...
    def define_problem(self):
        ...
        if self.pinned_contact_line:
            ...
            bubble_eqs+=(ConnectMeshAtInterface()+DirichletBC(_lagr_conn_mesh_x=0)@"interface")@"bubble_substrate" 
            # Neumann force to obtain the desired contact angle
            liquid_eqs+=NeumannBC(velocity_x=-self.interface.surface_tension*cos(self.contact_angle + (self.alpha)*degree))@"interface/liquid_substrate"
