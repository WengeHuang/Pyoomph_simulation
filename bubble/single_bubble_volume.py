...
class SingleBubblePlotter(MatplotlibPlotter):
    def define_plot(self):
        ...
        self.set_view(-0.5*xrange, -0.2*xrange, 0.5*xrange, 0.4*xrange)  # -x_min, -ymin, x_max, y_max of the view window
...
class SingleBubbleLaserProblem(Problem):
    ...
    def define_problem(self):
        ...
        bubble_eqs+=InitialCondition(pressure=6*sigma0/self.R0) # Start with some reasonable pressure, since the density depends on it
