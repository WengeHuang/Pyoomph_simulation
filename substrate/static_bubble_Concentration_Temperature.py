...
class SingleBubbleProblem(Problem):
    ...
    def define_problem(self):
        ...
        liquid_eqs+=NavierStokesFreeSurface(surface_tension=self.surface_tension, mass_transfer_rate=-self.mass_transfer_rate*1000, static_interface=True)@"interface"  #, static_interface=True
